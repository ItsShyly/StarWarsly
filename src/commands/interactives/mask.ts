// ^^^ Mask Command - Universal Concealment Action ^^^
...
export default {
  name: "mask",
  description: "Conceal your identity or intentions",
  defaultModOnly: false,
  globalCooldown: 3,
  execute: async (params: string[], context: BotCommandContext) => {
    await GlobalInteractiveHandler.handleInteractiveCommand("mask", context);
  },
};
