// ^^^ defend Command - Universal Defensive Action ^^^
...
export default {
  name: "defend",
  description: "Raise defensive systems or protection",
  defaultModOnly: false,
  globalCooldown: 3,
  execute: async (params: string[], context: BotCommandContext) => {
    await GlobalInteractiveHandler.handleInteractiveCommand("defend", context);
  },
};
